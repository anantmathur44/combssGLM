...
**COMBSS GLM** extends the original **COMBSS** framework to **generalized linear models (GLMs)**, providing tools for performing *best-subset selection* across non-linear likelihood-based models.
