...
class model:
    ...
    def fit(self, X_train, y_train, X_test, y_test, 
        ...
        """ 
        Fits the data to select a best subset of covariates from the list of subsets generated by COMBSS 
        over a grid of dynamically generated lambdas. The fit function calls the bss function.
        ...
        model.<attribute>. For example, the final optimal subset can be obtained by calling model.subset. 
        ...
        result = olog.bss(X_train, y_train, X_test, y_test, t_init=t_init, q = q, scaling=scaling, tau=tau, delta_frac=delta_frac, nlam = nlam, eta=eta, patience=patience, gd_maxiter=gd_maxiter, gd_tol=gd_tol, cg_maxiter = cg_maxiter, cg_tol=cg_tol)
